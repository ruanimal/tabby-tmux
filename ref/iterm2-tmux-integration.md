...
For practical tips on how to configure iTerm2 for use with tmux integration in the real world, please see [tmux Integration Best Practices](https://iterm2.com/documentation-tmux-integration-best-practices.html).
